...
export default function JekProfile() {
  ...
  const handlePassword = () =>
    withLoad(async () => {
      const res = await Requests.changePassword(
        id,
        newPassword,
        confirmPassword,
      );
  ...
  return (
    <Box maxW="100%" mx="auto" py={4} px={4}>
      <Button
      ...
      <Flex align="center" gap={4} mb={8}>
        ...
        <Box>
          ...
          <Text fontSize="12px" color="textSecondary" fontFamily="mono" mt={1}>
      ...
      <Box mb={6}>
        ...
        >
          <Row
            label={t("profile.profile.first_name")}
            value={hodim?.data?.first_name}
          />
          <Divider borderColor="border" />
          <Row
            label={t("profile.profile.last_name")}
            value={hodim?.data?.last_name}
          />
          <Divider borderColor="border" />
          <Row
            label={t("profile.profile.phone")}
            value={`+${hodim?.data?.phoneNumber}`}
          />
        </Box>
      </Box>
          ...
          >
            {hodim?.data?.addresses?.length > 0 ? (
              hodim.data.addresses.map((a, i) => (
                ...
                >
                  <Box>
                    ...
                    <Text fontSize="12px" color="textSecondary" mt="1px">
                      {a.neighborhood}
                    </Text>
                  </Box>
                </Flex>
              ...
              <Flex justify="space-between" align="center" py={3}>
                <Text fontSize="12px" color="textSecondary">
                  {t("profile.profile.no_address_jek")}
                </Text>
              </Flex>
            )}
          </Box>
...
borderRadius="md"
            ...
            {confirmPassword && newPassword !== confirmPassword && (
              <Text fontSize="11px" color="red.400">
                {t("profile.profile.password_mismatch")}
              </Text>
            )}
          </ModalBody>
